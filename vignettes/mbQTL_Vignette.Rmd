...
model with covariates (Shabalin, 2012). We have also created a larger simulated 
data set which can be accessed and downloaded from Movassagh, Mercedeh. (2023). mbQTL. https://doi.org/10.18129/B9.bioc.mbQTL.
...
# be concordant in the three datasets). Note, the data can be imported as
...
#Check out file formats compatible with mbQTL.
head(microbeAbund)
head(SnpFile)
head(CovFile)
